    ...
    return (
        <>
            ...
            <main className="grid grid-cols-[385px_1fr]">
                <Sidebar></Sidebar>
                <MainLayout>
                    <h1 className="font-bold text-3xl ml-40 mt-8">Profil użytkownika tester</h1>
                    <div className="dashboard-info gap-4 mt-8 mx-32">
                            ...
                            <CardContent className="pb-6 pl-16 pt-6 mr-64">
                                <div className="text-inputs grid grid-cols-2 gap-16">
                                    <div className="input-container">
                                        ...
                                        <Input type="text" className="py-6 border-slate-300" value="toster" />
                                    </div>
                                    <div className="input-container">
                                        <p className="font-bold text-lg mb-2">Adres e-mail</p>
                                        <Input type="email" className="py-6 border-slate-300"
                                               value="tester"/>
                                    </div>
                                </div>
                                ...
                                <SaveChangesButton className="float-right mt-8">Zapisz zmiany</SaveChangesButton>
                            </CardContent>
                        </Card>
                        <Card className="bg-white border border-slate-100 flex flex-col pt-4 w-3/5 mt-8">
                            <CardHeader className="text-left ml-2 space-y-0 pt-3 pb-5 pl-14">
                                <CardTitle className="text-2xl font-bold pb-2 text-[#760B0D]">Usuń konto</CardTitle>
                                <CardDescription>Uwaga! Tej czynności nie da się odwrócić i konto zostanie usunięte bezpowrotnie!</CardDescription>
                            </CardHeader>
                            <CardContent className="pb-6 pl-16 mr-64">
                                <DeleteAccountButton className="mt-8">Usuń konto użytkownika</DeleteAccountButton>
                            </CardContent>
                        </Card>
                        <Card className="bg-white border border-slate-100 flex flex-col pt-4 w-3/5 mt-8">
                            <CardHeader className="text-left ml-2 space-y-0 pt-3 pb-5 pl-14">
                                <CardTitle className="text-2xl font-bold pb-2">Aktywność użytkownika</CardTitle>
                            ...
                            <CardContent className="pb-6 pl-16 mr-64">
                                <Table>
                                    <TableHeader>
                                        <TableRow>
                                            <TableHead className="font-bold w-[216px]">Data i godzina zdarzenia</TableHead>
                                            <TableHead>Rodzaj zdarzenia</TableHead>
                                        </TableRow>
                                    </TableHeader>
                                    <TableBody>
                                        <TableRow>
                                            <TableCell className="font-medium">31 marca 2024 14:12</TableCell>
