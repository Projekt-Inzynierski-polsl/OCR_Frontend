                            ...
                            <CardContent className="pb-6 pl-16 pt-6 mr-64">
                                ...
                                <div className="text-inputs grid grid-cols-2 mt-12 gap-16">
                                    ...
                                    <div className="input-container">
                                        ...
                                        <Input type="text" readonly="true" className="py-6 border-slate-300" value="toster" />
                                    </div>
                                    <div className="input-container">
                                        <p className="font-bold text-lg mb-2">Poprawiony tekst</p>
                                        <Input type="text" readonly="true" className="py-6 border-slate-300"
                                               value="tester"/>
                                    </div>
                                </div>
                                ...
                                <div className="buttons-container grid grid-cols-2 mt-12 gap-8 w-2/3">
                                    <button
                                        className="border border-[#004601] text-[#004601] text-center font-bold rounded-[10px] py-3">Zaakceptuj
                                        poprawkę
                                    </button>
                                    <button
                                        className="border border-[#760B0D] text-[#760B0D] text-center font-bold rounded-[10px] py-3">Odrzuć
                                        poprawkę
                                    </button>
                                </div>
